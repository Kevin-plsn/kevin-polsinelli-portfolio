      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 py-12">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-bold mb-4 text-primary">Standardisation du parc d'impression</h2>
            ...
            <Card className="mb-8 shadow-md">
              ...
              <CardContent className="pt-4 prose max-w-none text-gray-700">
                <p>
                  Pour améliorer la gestion du parc d'impression et renforcer la sécurité des accès utilisateurs, nous avons engagé une démarche de standardisation en collaboration avec le prestataire RICOH. L'objectif était multiple : simplifier le suivi des consommables, limiter les erreurs de commande, gagner en réactivité en cas de panne, et centraliser l'ensemble des informations liées aux imprimantes.
                </p>
                <p>
                  L'outil Streamline NX a été déployé pour permettre un contrôle précis des impressions via des badges utilisateurs, assurant ainsi une meilleure traçabilité des impressions entrantes et sortantes. Ce projet visait à homogénéiser les équipements entre services, tout en professionnalisant la supervision et la sécurité documentaire au sein de l'entreprise.
                </p>
              </CardContent>
            </Card>
  ...
  if (project.id === "projet-2-migration-office") {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 py-12">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-bold mb-4 text-primary">Migration Office 365</h2>
  ...
  if (project.id === "projet-3-audit-securite") {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 py-12">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-bold mb-4 text-primary">Audit de sécurité</h2>
  ...
  if (project.id === "projet-4-informatique-industrielle") {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 py-12">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-bold mb-4 text-primary">Informatique industrielle</h2>
              ...
              <CardContent className="pt-4 space-y-8">
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Link 
                      to="/skills#organisation-personnelle" 
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Organisation personnelle</h5>
                    ...
                    <Link 
                      to="/skills#esprit-analyse" 
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Esprit d'analyse</h5>
                    ...
                    <Link 
                      to="/skills#adaptabilite" 
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Adaptabilité</h5>
                    ...
                    <Link 
                      to="/skills#capacite-apprentissage" 
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Capacité d'apprentissage</h5>
                    ...
                    <Link 
                      ...
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Rigueur</h5>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Link 
                      to="/skills#communication-relationnel" 
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Communication interservices</h5>
                    ...
                    <Link 
                      to="/skills#management-projet" 
                      className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                    >
                      <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Gestion de projet</h5>
                  ...
                  <div className="mb-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Link 
                        ...
                        className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                      >
                        <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Rédaction</h5>
                      ...
                      <Link 
                        to="/skills#conduite-projet-logiciel" 
                        className="bg-gray-50 p-4 rounded-lg shadow-sm hover:bg-gray-100 transition-colors block"
                      >
                        <h5 className="font-medium mb-1 text-primary hover:text-primary/80">Conduite de projet logiciel</h5>
  ...
  if (project.id === "projet-6-magellan-meteor") {
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 py-12">
          <div className="container max-w-4xl">
            <h2 className="text-3xl font-bold mb-4 text-primary">MAGELLAN – METEOR</h2>
