...
const ProfileSection = () => {
  return (
    <section id="profile" className="py-12 md:py-24 bg-gradient-to-b from-white to-gray-100">
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-8 space-y-4 animate-fade-in">
            ...
            <Badge variant="outline" className="bg-secondary text-white px-3 py-1 text-sm mb-4">
