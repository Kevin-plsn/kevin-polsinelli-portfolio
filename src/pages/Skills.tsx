...
const SkillsPage = () => {
  ...
  const skills: Skill[] = [
    ...
    },
    {
      ...
      relatedProjects: ["projet-2-migration-office", "projet-3-audit-securite", "projet-4-informatique-industrielle", "projet-5-magellan-sagt"]
    },
    {
      id: "esprit-analyse",
      ...
      relatedProjects: ["projet-1-standardisation-parc", "projet-3-audit-securite", "projet-4-informatique-industrielle", "projet-5-magellan-sagt"]
    },
    {
      id: "rigueur",
      title: "Rigueur",
    ...
    },
    {
      ...
      relatedProjects: ["projet-1-standardisation-parc", "projet-2-migration-office", "projet-3-audit-securite", "projet-4-informatique-industrielle"]
    },
    {
      id: "autonomie",
      title: "Autonomie",
  ...
  const projects: Project[] = [
    {
      ...
      shortDesc: "Optimisation et centralisation de la gestion des imprimantes et consommables."
    },
    {
            ...
            <TabsContent value={activeTab} className="space-y-6">
              {filteredSkills.map((skill) => (
                <Collapsible
                  ...
                  className="w-full"
                >
                  <Card id={skill.id} className="border border-primary/20 transition-all duration-300 hover:shadow-md">
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <div>
                          <CardTitle className="text-xl text-primary">{skill.title}</CardTitle>
                          <CardDescription className="mt-1">{skill.category === "technique" ? "Compétence technique" : skill.category === "comportementale" ? "Compétence comportementale" : "Compétence générale"}</CardDescription>
                        </div>
                        <CollapsibleTrigger asChild>
                          <Button variant={openSkill === skill.id ? "secondary" : "outline"}>
                    ...
                    <CardContent>
                      ...
                      <CollapsibleContent className="mt-6 space-y-4">
                        <div>
                          <h3 className="font-semibold text-lg mb-2">Mise en application</h3>
                          <p className="text-sm text-foreground">{skill.application}</p>
                        </div>
                        
                        <div>
                          <h3 className="font-semibold text-lg mb-2">Bilan de compétences professionnelles</h3>
                          <p className="text-sm text-foreground">{skill.assessment}</p>
                        </div>
                        
                        {skill.relatedProjects.length > 0 && (
                          <div>
                            <h3 className="font-semibold text-lg mb-4">Projets associés</h3>
