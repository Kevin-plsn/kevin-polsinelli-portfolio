          ...
          {expandedSkill ? (
            ...
            displayedSkills.map((skill) => (
              <div key={skill.id} id={skill.id}>
                ...
                <Card className="mb-8">
                  <CardHeader>
                    <CardTitle className="text-xl">🛠️ Mise en application</CardTitle>
                  </CardHeader>
                  <CardContent>
