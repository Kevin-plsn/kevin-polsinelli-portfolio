    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 py-12">
        <div className="container mx-auto px-4">
          {!expandedSkill && (
            <>
              <h1 className="text-4xl md:text-5xl font-bold text-center text-green-600 mb-12">Mes Compétences</h1>
          ...
          {expandedSkill ? (
              ...
              <div key={skill.id} id={skill.id}>
                ...
                <Card className="mb-8">
                  <CardHeader className="bg-green-50">
                    <CardTitle className="text-xl text-green-600">📝 Définition</CardTitle>
                  </CardHeader>
                ...
                <Card className="mb-8">
                  <CardHeader className="bg-green-50">
                    <CardTitle className="text-xl text-green-600">🛠 Mise en application</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-4">
                ...
                <Card className="mb-8">
                  <CardHeader className="bg-green-50">
                    <CardTitle className="text-xl text-green-600">💬 Mon point de vue sur la compétence</CardTitle>
                  </CardHeader>
                  <CardContent className="pt-4">
                ...
                {skill.relatedProjects.length > 0 && (
                  <div className="mt-12">
                    <h3 className="text-2xl font-semibold mb-6 text-green-600">📂 Projets associés</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {skill.relatedProjects.map(projectId => (
                        ...
                        >
                          <Card className="hover:shadow-md transition-shadow border border-green-200 bg-green-50">
                            ...
                            <CardContent className="p-4">
                              <h4 className="font-semibold text-green-600">{getProjectTitle(projectId)}</h4>
                            </CardContent>
                          </Card>
                        </Link>
                      ))}
            ...
            // Grid of skill cards grouped by category
            <div className="space-y-12">
              {["generale", "technique", "comportementale"].map(category => {
                const categorySkills = filteredSkills.filter(skill => skill.type === category);
                if (categorySkills.length === 0) return null;
                
                const categoryTitle = category === "generale" ? "Générales" : 
                                   category === "technique" ? "Techniques" : 
                                   "Comportementales";
                
                return (
                  <div key={category}>
                    <h2 className="text-2xl font-bold text-green-600 mb-6">{categoryTitle}</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {categorySkills.map((skill) => (
                        <Card 
                          key={skill.id} 
                          id={skill.id}
                          className="hover:shadow-md transition-all border border-green-200 h-full flex flex-col bg-green-50"
                        >
                          <CardHeader className="flex flex-row items-center gap-4 pb-2 bg-green-100">
                            <div className="bg-green-200 p-2 rounded-full">
                              {skill.icon}
                            </div>
                            <CardTitle className="text-lg text-green-700">{skill.title}</CardTitle>
                          </CardHeader>
                          ...
                          <CardContent className="pt-4 flex-grow">
                            ...
                            <Badge className="mb-2 bg-green-200 text-green-700" variant="outline">
                              {skill.type === "technique" 
                                ? "Compétence technique" 
                                : skill.type === "comportementale" 
                                ? "Compétence comportementale" 
