    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 py-12">
        <div className="container max-w-4xl mx-auto px-4">
          <h1 className="text-3xl font-bold mb-4 text-primary">MAGELLAN – SAGT</h1>
          <p className="text-lg text-gray-600 mb-8">
            Standardisation et optimisation des règles d'automatisation dans le système d'aide à la gestion du trafic d'APRR.
          </p>
          ...
          <Card className="shadow-md">
            ...
            <CardContent className="pt-4 space-y-8">
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-orange-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-orange-600">Organisation personnelle</h5>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-orange-600">Esprit d'analyse</h5>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-orange-600">Adaptabilité</h5>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-orange-600">Capacité d'apprentissage</h5>
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-orange-600">Rigueur</h5>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-yellow-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-yellow-700">Communication interservices</h5>
                  ...
                  <div className="bg-yellow-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-yellow-700">Gestion de projet</h5>
              ...
              <div>
                <h4 className="text-lg font-semibold text-cyan-600 mb-4 flex items-center gap-2">
                  <span>💻</span>
                  Savoir-faire techniques
                </h4>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-cyan-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-cyan-700">Rédaction</h5>
                  ...
                  <div className="bg-cyan-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-cyan-700">Conduite de projet logiciel</h5>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-cyan-600">MAGELLAN – Module SAGT</h5>
                    <p className="text-sm text-gray-600">Logiciel métier pour la gestion automatisée des événements trafic.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-green-600">Excel</h5>
                    <p className="text-sm text-gray-600">Pour la structuration de la nomenclature.</p>
                  </div>
                  <div className="bg-gray-50 p-4 rounded-lg shadow-sm">
                    <h5 className="font-medium mb-1 text-blue-600">Outils internes APRR</h5>
