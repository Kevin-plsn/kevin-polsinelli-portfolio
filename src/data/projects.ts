...
export const projects: Project[] = [
  {
    ...
    detailedSkills: {
      transverses: ["Autonomie", "Esprit d'analyse", "Organisation personnelle"],
      generaux: ["Gestion de projet", "Rédaction"],
      techniques: ["Support technique", "Sécurité informatique", "Conception réseau"]
    }
  },
  {
    ...
    detailedSkills: {
      transverses: ["Rigueur", "Organisation personnelle", "Adaptabilité", "Autonomie", "Esprit d'analyse", "Résolution de problèmes", "Capacité d'apprentissage"],
      generaux: ["Rédaction", "Gestion de projet"],
      techniques: ["Support technique"]
    }
  },
  {
    ...
    detailedSkills: {
      transverses: ["Autonomie", "Rigueur", "Esprit d'analyse", "Résolution de problèmes", "Capacité d'apprentissage"],
      generaux: ["Rédaction"],
      techniques: ["Système Windows / Active Directory", "Sécurité informatique"]
    }
  },
  {
    ...
    detailedSkills: {
      transverses: ["Autonomie", "Esprit d'analyse", "Résolution de problèmes", "Adaptabilité", "Organisation personnelle"],
      generaux: ["Rédaction"],
      techniques: ["Systèmes Windows / Active Directory", "Sécurité informatique", "Support technique"]
    }
  },
  {
    ...
    detailedSkills: {
      transverses: ["Organisation personnelle", "Esprit d'analyse", "Adaptabilité", "Capacité d'apprentissage", "Rigueur"],
      generaux: ["Communication interservices", "Gestion de projet", "Rédaction"],
      techniques: ["Conduite de projet logiciel"]
    }
  },
  {
    ...
    detailedSkills: {
      transverses: ["Esprit d'analyse", "Adaptabilité", "Autonomie"],
      generaux: ["Rédaction", "Communication interservices"],
      techniques: ["Ergonomie et interfaces homme-machine", "Conduite de projet logiciel"]
    }
  }
];
