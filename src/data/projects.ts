...
export const projects: Project[] = [
  ...
  },
  {
    ...
    skills: ["autonomie", "rigueur", "esprit-analyse", "resolution-problemes", "capacite-apprentissage", "redaction", "systemes-windows-active-directory", "securite-informatique"]
  },
  {
    ...
    skills: ["autonomie", "esprit-analyse", "resolution-problemes", "adaptabilite", "organisation-personnelle", "redaction", "systemes-windows-active-directory", "securite-informatique", "support-technique"]
  },
  {
  ...
  },
  {
    ...
    skills: ["esprit-analyse", "adaptabilite", "autonomie", "redaction", "communication-interservices", "ergonomie-interfaces-homme-machine", "conduite-projet-logiciel"]
  }
];
...
export const getSkillName = (skillId: string) => {
  const skillNames: {[key: string]: string} = {
    ...
    "systemes-windows-active-directory": "Systèmes Windows / Active Directory",
    "communication-interservices": "Communication interservices",
    "conduite-projet-logiciel": "Conduite de projet logiciel",
    "ergonomie-interfaces-homme-machine": "Ergonomie et interfaces homme-machine"
  };
