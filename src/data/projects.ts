...
export const projects: Project[] = [
  {
    ...
    skills: ["autonomie", "esprit-analyse", "organisation-personnelle", "management-projet", "redaction", "support-technique", "securite", "conception-reseau"]
  },
  {
  ...
  },
  {
    ...
    skills: ["autonomie", "esprit-analyse", "adaptabilite", "resolution-problemes", "redaction", "administration-windows", "securite", "support-technique"]
  },
  {
  ...
  },
  {
    ...
    skills: ["esprit-analyse", "adaptabilite", "autonomie", "redaction", "communication-interservices", "ergonomie-interfaces", "conduite-projet-logiciel"]
  }
];
...
export const getSkillName = (skillId: string) => {
  const skillNames: {[key: string]: string} = {
    ...
    "ergonomie-interfaces": "Ergonomie et interfaces homme-machine"
  };
