...
export const projects: Project[] = [
  ...
  },
  {
    ...
    skills: ["autonomie", "rigueur", "esprit-analyse", "resolution-problemes", "capacite-apprentissage", "redaction", "securite-informatique", "systeme-windows-active-directory"]
  },
  {
    ...
    skills: ["autonomie", "esprit-analyse", "resolution-problemes", "adaptabilite", "organisation-personnelle", "redaction", "systeme-windows-active-directory", "securite-informatique", "support-technique"]
  },
  {
...
export const getSkillName = (skillId: string) => {
  const skillNames: {[key: string]: string} = {
    ...
    "systeme-windows-active-directory": "Système Windows / Active Directory",
