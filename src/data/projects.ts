...
export const projects: Project[] = [
  {
    ...
    skills: ["autonomie", "esprit-analyse", "organisation-personnelle", "management-projet", "initiative", "securite", "communication-relationnel"]
  },
  {
    ...
    skills: ["rigueur", "organisation-personnelle", "autonomie", "esprit-analyse", "communication-relationnel", "bureautique-productivite", "management-projet"]
  },
  {
    ...
    skills: ["securite", "administration-windows", "rigueur", "autonomie", "esprit-analyse", "organisation-personnelle", "communication-relationnel"]
  },
  {
    ...
    realization: "J'ai assuré la création, modification et suppression des comptes dans l'Active Directory pour suivre l'évolution fréquente du personnel. En parallèle, j'ai veillé au bon fonctionnement des postes informatiques intégrés à la production, souvent en interaction directe avec les automates industriels. En totale autonomie, j'ai organisé mes interventions selon les priorités métiers, tout en maintenant un environnement stable malgré le manque de documentation initiale. Cette mission m'a appris à jongler entre réactivité, rigueur et autonomie dans un cadre à forte contrainte opérationnelle. \n\n✅ Compétences mobilisées\n\n🧠 Compétences transverses\n\nAutonomie – Prise de poste sans passation, responsabilité de l'ensemble du périmètre industriel.\n\nEsprit d'analyse – Diagnostic rapide des pannes, compréhension des causes profondes, adaptation aux spécificités techniques de chaque ligne.\n\nRésolution de problèmes – Intervention sur des lignes bloquées (ex. IMA), avec des temps d'arrêt minimisés.\n\nAdaptabilité – Capacité à naviguer entre plusieurs technologies industrielles non documentées et à m'ajuster en temps réel.\n\nOrganisation personnelle – Gestion simultanée de demandes urgentes, planification des audits et création de suivi structuré.\n\n📅 Savoir-faire généraux\n\nRédaction – Élaboration de tableaux de suivi et documentation claire pour les audits de ligne.\n\n💻 Savoir-faire techniques\n\nSystèmes Windows / Active Directory – Gestion complète des comptes, intégration des postes au domaine, configuration spécifique pour postes industriels.\n\nSécurité informatique – Renforcement des accès aux postes et aux systèmes critiques, contrôle des privilèges.\n\nSupport technique – Dépannage en environnement sensible, interventions en autonomie sur des systèmes critiques.",
    skills: ["administration-windows", "organisation-personnelle", "autonomie", "esprit-analyse", "communication-relationnel", "rigueur", "securite", "initiative", "bureautique-productivite"]
  },
  {
